...
pub contract TokenForwarding {
    ...
    // Event that is emitted when the tokens are deposited to the target receiver
    ...
    pub resource Forwarder: FungibleToken.Receiver {
        ...
        // deposit
        // Function that takes a Vault resource as an argument and forwards
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            ...
            receiverRef.deposit(from)

            emit ForwardedDeposit(amount: balance, from: self.owner?.address)
        }

        // changeRecipient
        // Function that changes the recipient of the forwarder
    ...
    // createNewForwarder
    // Function that creates a new Forwarder reference with the provided recipient
    //
